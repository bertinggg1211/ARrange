            ...
            <View style={styles.modernShopCard}>
              ...
              <View style={styles.modernSpecsSection}>
                ...
                <TouchableOpacity
                  ...
                  onPress={() => {
                    console.log('📋 Opening specifications modal');
              ...
              <View style={styles.enhancedModalContainer}>
                ...
                <View style={styles.enhancedModalHeader}>
                  ...
                  <View style={styles.enhancedHeaderContent}>
                    <View style={styles.enhancedTitleSection}>
                      <View style={styles.enhancedIconContainer}>
                        <Icon name="information-circle" size={24} color="#6366F1" />
                      </View>
                      <Text style={styles.enhancedModalTitle}>Product Details</Text>
                    </View>
                    <TouchableOpacity
                  ...
                  <View style={styles.enhancedOverviewCard}>
                    <View style={styles.enhancedOverviewHeader}>
                      <View style={styles.enhancedOverviewInfo}>
                        <Text style={styles.enhancedOverviewTitle}>{product?.name || 'Product'}</Text>
                        <Text style={styles.enhancedOverviewCategory}>{product?.category || 'Lighting'}</Text>
                      </View>
                  ...
                  <View style={styles.enhancedSectionsContainer}>
                    ...
                    <View style={styles.enhancedSection}>
                      <View style={styles.enhancedSectionHeader}>
                        ...
                        <Text style={styles.enhancedSectionTitle}>Basic Information</Text>
                      </View>
                      <View style={styles.enhancedSectionContent}>
                        <View style={styles.enhancedSpecItem}>
                          ...
                          <View style={styles.enhancedSpecContent}>
                            ...
                            <Text style={styles.enhancedSpecValue}>
                              {product?.stock ? `${product.stock} units` : 'Contact seller'}
                            </Text>
                          </View>
                        </View>
                        ...
                        <View style={styles.enhancedSpecItem}>
                          ...
                          <View style={styles.enhancedSpecContent}>
                            ...
                            <Text style={styles.enhancedSpecValue}>{product?.warranty || 'Standard warranty'}</Text>
                          </View>
                        </View>
                        ...
                        {product?.brand && (
                          <View style={styles.enhancedSpecItem}>
                            ...
                            <View style={styles.enhancedSpecContent}>
                              ...
                              <Text style={styles.enhancedSpecValue}>{product.brand}</Text>
                            </View>
                          </View>
                        )}
                        ...
                        {product?.model && (
                          <View style={styles.enhancedSpecItem}>
                            ...
                            <View style={styles.enhancedSpecContent}>
                              ...
                              <Text style={styles.enhancedSpecValue}>{product.model}</Text>
                            </View>
                          </View>
                        )}
                      </View>
                    ...
                    <View style={styles.enhancedSection}>
                      <View style={styles.enhancedSectionHeader}>
                        ...
                        <Text style={styles.enhancedSectionTitle}>Physical Properties</Text>
                      </View>
                      <View style={styles.enhancedSectionContent}>
                        <View style={styles.enhancedSpecItem}>
                          <View style={styles.enhancedSpecIcon}>
                          ...
                          <View style={styles.enhancedSpecContent}>
                            ...
                            <Text style={styles.enhancedSpecValue}>{product?.dimensions || 'See product images'}</Text>
                          </View>
                        </View>
                        ...
                        <View style={styles.enhancedSpecItem}>
                          ...
                          <View style={styles.enhancedSpecContent}>
                            ...
                            <Text style={styles.enhancedSpecValue}>{product?.weight || 'Contact seller'}</Text>
                          </View>
                        </View>
                        ...
                        <View style={styles.enhancedSpecItem}>
                          ...
                          <View style={styles.enhancedSpecContent}>
                            ...
                            <Text style={styles.enhancedSpecValue}>{product?.material || 'Premium materials'}</Text>
                          </View>
                        </View>
                      </View>
                    </View>
                    ...
                    {(product?.bulbType || product?.numberOfBulbs || product?.voltage || product?.ledType || product?.lumens || product?.isDimmable !== undefined || product?.installationType || product?.roomType) && (
                      <View style={styles.enhancedSection}>
                        <View style={styles.enhancedSectionHeader}>
                          <View style={styles.enhancedSectionIcon}>
                            <Icon name="flash-outline" size={20} color="#DC2626" />
                          </View>
                          <Text style={styles.enhancedSectionTitle}>Technical Specifications</Text>
                        </View>
                        <View style={styles.enhancedSectionContent}>
                          {product?.bulbType && (
                            <View style={styles.enhancedSpecItem}>
                              ...
                              <View style={styles.enhancedSpecContent}>
                                ...
                                <Text style={styles.enhancedSpecValue}>{product.bulbType}</Text>
                              </View>
                            </View>
                          )}
                          ...
                          {product?.numberOfBulbs && (
                            <View style={styles.enhancedSpecItem}>
                              ...
                              <View style={styles.enhancedSpecContent}>
                                ...
                                <Text style={styles.enhancedSpecValue}>{product.numberOfBulbs}</Text>
                              </View>
                            </View>
                          )}
                          ...
                          {product?.voltage && (
                            <View style={styles.enhancedSpecItem}>
                              <View style={styles.enhancedSpecIcon}>
                                <Icon name="battery-charging" size={16} color="#10B981" />
                              </View>
                              <View style={styles.enhancedSpecContent}>
                                <Text style={styles.enhancedSpecLabel}>Voltage</Text>
                                <Text style={styles.enhancedSpecValue}>{product.voltage}</Text>
                              </View>
                            </View>
                          )}
                          ...
                          {product?.ledType && (
                            <View style={styles.enhancedSpecItem}>
                              ...
                              <View style={styles.enhancedSpecContent}>
                                ...
                                <Text style={styles.enhancedSpecValue}>{product.ledType}</Text>
                              </View>
                            </View>
                          )}
                          ...
                          {product?.lumens && (
                            <View style={styles.enhancedSpecItem}>
                              ...
                              <View style={styles.enhancedSpecContent}>
                                ...
                                <Text style={styles.enhancedSpecValue}>{product.lumens} lumens</Text>
                              </View>
                            </View>
                          )}

                          {product?.isDimmable !== undefined && (
                            <View style={styles.enhancedSpecItem}>
                              <View style={styles.enhancedSpecIcon}>
                                <Icon name={product.isDimmable ? "checkmark-circle" : "close-circle"} size={16} color={product.isDimmable ? "#10B981" : "#EF4444"} />
                              </View>
                              <View style={styles.enhancedSpecContent}>
                                <Text style={styles.enhancedSpecLabel}>Dimmable</Text>
                                <Text style={styles.enhancedSpecValue}>{product.isDimmable ? 'Yes' : 'No'}</Text>
                              </View>
                            </View>
                          )}
                          ...
                          {product?.installationType && (
                            <View style={styles.enhancedSpecItem}>
                              ...
                              <View style={styles.enhancedSpecContent}>
                                ...
                                <Text style={styles.enhancedSpecValue}>{product.installationType}</Text>
                              </View>
                            </View>
                          )}
                          ...
                          {product?.roomType && (
                            <View style={styles.enhancedSpecItem}>
                              ...
                              <View style={styles.enhancedSpecContent}>
                                ...
                                <Text style={styles.enhancedSpecValue}>{product.roomType}</Text>
                              </View>
                            </View>
                          )}
                        </View>
                    ...
                    {(product?.deliveryCharge || product?.installationCost || product?.freeDeliveryThreshold || product?.installationIncluded !== undefined) && (
                      <View style={styles.enhancedSection}>
                        <View style={styles.enhancedSectionHeader}>
                          ...
                          <Text style={styles.enhancedSectionTitle}>Delivery & Installation</Text>
                        </View>
                        <View style={styles.enhancedSectionContent}>
                          {product?.deliveryCharge && product.deliveryCharge > 0 && (
                            <View style={styles.enhancedSpecItem}>
                              ...
                              <View style={styles.enhancedSpecContent}>
                                <Text style={styles.enhancedSpecLabel}>Delivery Charge</Text>
                                <Text style={styles.enhancedSpecValue}>₱{product.deliveryCharge}</Text>
                              </View>
                            </View>
                          )}
                          ...
                          {product?.installationCost && product.installationCost > 0 && (
                            <View style={styles.enhancedSpecItem}>
                              ...
                              <View style={styles.enhancedSpecContent}>
                                <Text style={styles.enhancedSpecLabel}>Installation Cost</Text>
                                <Text style={styles.enhancedSpecValue}>₱{product.installationCost}</Text>
                              </View>
                            </View>
                          )}
                          ...
                          {product?.freeDeliveryThreshold && product.freeDeliveryThreshold > 0 && (
                            <View style={styles.enhancedSpecItem}>
                              ...
                              <View style={styles.enhancedSpecContent}>
                                <Text style={styles.enhancedSpecLabel}>Free Delivery Threshold</Text>
                                <Text style={styles.enhancedSpecValue}>₱{product.freeDeliveryThreshold}</Text>
                              </View>
                            </View>
                          )}
                          ...
                          {product?.installationIncluded !== undefined && (
                            <View style={styles.enhancedSpecItem}>
                              ...
                              <View style={styles.enhancedSpecContent}>
                                <Text style={styles.enhancedSpecLabel}>Installation Included</Text>
                                <Text style={styles.enhancedSpecValue}>
                                  {product.installationIncluded ? 'Yes' : 'No'}
                                </Text>
                              </View>
                    ...
                    {product?.specifications && product.specifications.length > 0 && (
                      <View style={styles.enhancedSection}>
                        <View style={styles.enhancedSectionHeader}>
                          ...
                          <Text style={styles.enhancedSectionTitle}>Additional Specifications</Text>
                        </View>
                        <View style={styles.enhancedSectionContent}>
                          {product.specifications.map((spec, index) => (
                            spec.name && spec.value ? (
                              <View key={index} style={styles.enhancedSpecItem}>
                                ...
                                <View style={styles.enhancedSpecContent}>
                                  <Text style={styles.enhancedSpecLabel}>{spec.name}</Text>
                                  <Text style={styles.enhancedSpecValue}>{spec.value}</Text>
                                </View>
                              </View>
                            ) : null
                          ))}
