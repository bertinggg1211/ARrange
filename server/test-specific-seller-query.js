 ...
 * 
 * This script tests the specific query mentioned in the error:
 * SELECT * FROM messages WHERE seller_id = '18a0f468-82b5-4fb2-ab5a-6d5484f7bfbe';
 */

async function testSpecificSellerQuery() {
  console.log('🧪 Testing specific seller query...');
  ...
  try {
    ...
    // Test 1: Check if seller exists in users table
    console.log('\n📋 Step 1: Checking if seller exists in users table...');
...
module.exports = testSpecificSellerQuery;
